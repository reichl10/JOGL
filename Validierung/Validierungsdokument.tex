...
\hline
\#91 & Bei Maßstabsanzeige sollte Einheit angegeben werden. & \\
\hline
\end{longtable}
...
\#91 & Bei Maßstabsanzeige sollte Einheit angegeben werden. & \\
\hline
93,92,90,88,87,85,91,80,73,57,56,55,52,51,48,41,36,35,31,29,20,16,11,7
\hline
\end{longtable}
...
\begin{longtable}{|l|p{4,4cm}|p{4,4cm}||}
\hline
Code & Kommentare & Leere Zeilen\\
\hline
\hline
11088 & 3180 & 2861 \\
\hline
\end{longtable}
Zu Ende von der Validierung:
\begin{longtable}{|l|p{4,4cm}|p{4,4cm}||}
\hline
Code & Kommentare & Leere Zeilen\\
\hline
