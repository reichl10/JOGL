...
\hline
\#3 & Settings werden nicht korrekt in die UI geladen &
\hline
\#4 & Detaillevel-Einstellung stimmt nicht mit der UI überein &
\hline
\#15 & Mond im Sonnensystemmodus sieht verzerrt aus & Wird nicht gefixt
\hline
\#17 & Sprachänderung klappt nicht immer. &
\hline
\#21 & Noch nicht implementierte Tastatureingaben &
\hline
\#25 & Einheit bei Cachegrößen in der GUI fehlt &
\hline
\#27 & Exception im MainWindow beim Programmstart &
\hline
\#28 & Anfragen bei Nominatim geben bei der zweiten Suche Null zurück (NominatimSource Zeile 110) &
\hline
\#30 & Aus- und Einblenden der Seitenleiste zerschießt das Layout &
\hline
\#34 & Bei der Auswahl von langen Suchergebnissen verschiebt sich die Auswahlmöglichkeit "In der Nähe" und "Weltweit" &
\#40 & Anzeige-Tab sollte eventuell Ansicht-Tabe heisen (wie im Pflichtenheft Text?) &
\hline
\#44 & Sollte Numberformat Exception abfangen &
\hline
\#47 & ProgressManager wird nach dem vollständigen Laden nicht zurückgesetzt &
\hline
\#49 & Step bei Cachegröße sollte 10 MB sein nicht 1 MB &
\hline 
\#50 & Overpassanfragen dauern zu lange. &
\hline
\#53 & Globus wird bei LevelOfDetail = LOW und rumgeklicke zu einer Ebene &
\hline
\#58 & Lokale Suche funktioniert nicht (Ergebnisse erscheinen kurz im Auswahlfenster, verschwinden dann aber wieder) &
\end{longtable}
