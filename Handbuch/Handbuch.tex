...
\hline
\parbox[0pt][1cm][c]{0cm}{} {\includegraphics[scale=0.6]{images/Massstab.eps}} & Maßstab \\ 
\hline
...
\hline
\hline
{\includegraphics[scale=1.6]{images/POI_Activity.eps}} & Aktivitäten \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_Bank.eps}} & Bank \\ 
\hline
{\includegraphics[scale=1.5]{images/USER_TAG.png}} & Benutzermarkierungen \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_education.eps}} & Bildung \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_Shop.eps}} & Geschäfte \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_health.eps}} & Gesundheitseinrichtungen \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_hotels.eps}} & Hotels \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_Grocery.eps}} & Lebensmittelgeschäfte \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_nightlife.eps}} & Nachtleben \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_post.eps}} & Post \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_Restaurant.eps}} & Restaurants \\ 
\hline
{\includegraphics[scale=1.5]{images/SEARCH.png}} &  Suchergebnisse \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_Toilets.eps}} & Toiletten \\ 
\hline
{\includegraphics[scale=1.6]{images/POI_hiking_cycling.eps}} & Wandern und Radfahren \\ 
\hline
\end{tabular}
