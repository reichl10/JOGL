...
\begin{itemize}
\item Die Teile der JOGL-Bibliothek \index{JOGL} sind unter mehreren Versionen der BSD-Lizenz, der SGI Free Software License und der Apache-Lizenz, der Ubuntu Font License und mehreren proprietären Lizenzen veröffentlicht. Details dazu finden sich bei  \footnote{\url{https://jogamp.org/git/?p=jogl.git;a=blob;f=LICENSE.txt}}.
...
\hline
\rule[-1ex]{0pt}{7ex} \includegraphics[scale=0.08]{images/key_enter.eps} & \textref{Suche} starten (z.B. nach der Eingabe eines Orts) \\ 
\hline
...
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Strassenkarte1.png}}
    \hspace{5mm}    
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Strassenkarte2.png}}
\end{figure} 
...
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Radkarte1.png}}
    \hspace{5mm}
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Radkarte2.png}}
\end{figure} 
...
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Landkarte1.png}}
    \hspace{5mm}
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Landkarte2.png}}
\end{figure}
...
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Wanderkarte1.png}}
    \hspace{5mm}
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_Wanderkarte2.png}}
\end{figure} 
...
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_osmworld1.png}}
    \hspace{5mm}
    \subfigure{\includegraphics[scale=0.195]{images/flacheKarte_osmworld2.png}}
\end{figure}
...
\begin{enumerate}
\item Auswahl eines beliebigen \textref{Ansichtsmodi}.
\item Auswahl eines beliebigen \textref{Kartentyps}.
\item Zum gewünschten Punkt/ Ort navigieren.
\item Doppelklick auf den gewünschten Punkt/ Ort zentriert diesen im \textbf{Ansichtsfenster}.
...
\includegraphics[scale=0.5]{images/info.eps} & Um das Symbol der Benutzermarkierungen im \textbf{Ansichtsfenster} einzublenden, muss im \textref{Menü Orte} in der Liste \textbf{Overlays} das Feld der \textbf{Benutzermarkierungen} angewählt werden.
\end{tabular}
...
\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}} \index{Overlays}
\includegraphics[scale=0.5]{images/info.eps} & Um lediglich das Symbol der Benutzermarkierungen im \textbf{Ansichtsfenster} auszublenden, muss im \textref{Menü Orte} in der Liste \textbf{Overlays} das Feld der \textbf{Benutzermarkierungen} abgewählt werden.
\end{tabular}

\vspace{3mm}
\begin{figure}[!htb]
	\centering
    \subfigure{\includegraphics[scale=0.195]{images/Benutzermarkierungs_Dialog4.png}}
    \hspace{5mm}
    \subfigure{\includegraphics[scale=0.195]{images/Benutzermarkierungs_Dialog5.png}}
\end{figure}
...
\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}}
\includegraphics[scale=0.5]{images/info.eps} & Das \textbf{Höhenprofil} ist in mehreren \textref{Ansichtsmodi} (nicht für \textref{Sonnensystem}) für mehrere \textref{Kartentypen} (nicht für \textref{OSM2World} und \textref{Kinderweltkarte}) zuschaltbar. \\ 
\end{tabular} 
...
Die Breite des grauen Balkens entspricht der Länge in Metern im \textref{Ansichtsfenster}.
...
\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}} \index{Overlays}
\includegraphics[scale=0.5]{images/info.eps} & Um eines der Symbole für POIs im \textbf{Ansichtsfenster} einzublenden, muss im \textref{Menü Orte} in der Liste \textbf{Overlays} das Feld des jeweiligen POI-Types (\textref{Liste verfügbarer POIs}) angewählt werden.
\end{tabular}


\vspace{3mm}
\begin{center}
\includegraphics[scale=0.3]{images/flacheKarte_pois.png}
\end{center}
...
Optionen:
\begin{itemize}
\item \textbf{in der Nähe}: Es werden nur Suchergebnisse angezeigt, welche sich im aktuell sichtbaren Kartenausschnitt (\textbf{Ansichtsfenster}) befinden.
...
\item Klick auf das Such-Symbol bzw. Drücken der Enter-Taste erwirkt die Ausgabe der Suchergebnisse im darunterliegenden Ausgabefeld. Das \textbf{Ansichtsfenster} blieb sich dato unverändert.
	\vspace{2mm}
	\begin{center}
	\includegraphics[scale=0.3]{images/flacheKarte_suche1.png}
	\end{center}
\item Klick auf das entsprechende Suchergebnis zentriert den gewünschten Punkt im \textbf{Ansichtsfenster}.
	\vspace{2mm}
	\begin{center}
...
Benutzer"-oberfläche \index{Benutzeroberfläche} & \\
