...
\hline
\hline
\rule[-1ex]{0pt}{4ex} \textit{kursiv} & kursiv formatierte Textausschnitte sind zum üben gedacht und sollen in \JoglEarth ausprobiert werden, sozusagen als Beispiele \\
\hline
...
Die gesamte Menüführung befindet sich in der linken \textbf{Seitenleiste}.
...
\vspace{5mm}
\begin{enumerate}
\item \textbf{\large Menü: Anzeige} \index{Menü Anzeige}
...
\newpage
\item \textbf{\large Menü: Orte} \index{Menü Orte}
\begin{itemize}
...
\vspace{3mm}
\item \textbf{\large Menü: Einstellungen} \index{Menü Einstellungen}
\begin{itemize}
...
\vspace{3mm}
\item \textbf{\large Menü: Details} \index{Menü Details}

\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}}
\includegraphics[scale=0.5]{images/info.eps} & Der Bereich \textbf{Details} verändert sich beim Wechseln der Menüs nicht.
\end{tabular}
