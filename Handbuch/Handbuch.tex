...
\vspace{3mm} \index{Program-Icons} \index{Benutzeroberfläche} \index{Navigation Globus / Kartenebene}
In den folgenden Kapiteln finden Sie als Einführung die Erklärungen zu den \textref{Program-Icons}, zur \textref{Benutzeroberfläche}, zur \textref{Navigation} auf dem Globus und der Kartenebene.
...
\item Cachegrößen:
	\begin{itemize}
	\item Arbeitsspeicher: 200 MB
	\item Dateisystem: 1.024 MB
	\end{itemize}
\end{itemize}
...
\item Bilinear
\item Trilinear
\item 2x Anisotropisch
\item 4x Anisotropisch
\item 8x Anisotropisch
\item 16x Anisotropisch
\end{itemize}
