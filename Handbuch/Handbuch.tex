...
\newpage
\subsection{Menüführung} \index{Menüführung}
Die gesamte Menüführung befindet sich in der linken \textbf{Seitenleiste} und deckt die wichtigsten Funktionalitäten (\textref{Funktionen}) von \JoglEarth ab. 
...
\vspace{5mm}
\subsubsection{1. Menü: Anzeige} \index{Menü Anzeige}
...
\vspace{3mm}
\subsubsection{2. Menü: Orte} \index{Menü Orte}
\begin{minipage}[t]{9cm}
\vspace{-40mm}
	\begin{itemize}
...
\vspace{3mm}
\subsubsection{3. Menü: Einstellungen} \index{Menü Einstellungen}
\begin{minipage}[t]{9cm}
\vspace{-40mm}
	\begin{itemize}
...
\vspace{3mm}
\subsubsection{4. Menü: Details} \index{Menü Details}
...
\vspace{3mm}
\section{Sonnensystem} \index{Ansichtsmodi!Sonnensystem}
...
\vspace{3mm}
\section{Globus} \index{Ansichtsmodi!Globus}
...
\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}}
\includegraphics[scale=0.5]{images/info.eps} &  Funktionalität: Diese Ansicht unterstützt die gesamte Funktionalität von \JoglEarth , wie beispielsweise Aktivieren des Höhenprofils, Markieren von Punkten, etc.
\end{tabular}
...
\vspace{3mm}
\section{Flache Karte} \index{Ansichtsmodi!Karte}
...
\vspace{3mm}
\section{Satellit} \index{Kartentypen!Satellit}
...
\vspace{3mm}
\section{OpenStreetMap} \index{Kartentypen!OpenStreetMap}
...
\subsection{Straßenkarte} \index{OpenStreetMap!Straßenkarte}
...
\subsection{Radkarte} \index{OpenStreetMap!Radkarte}
\subsection{Landkarte}
\subsection{Wanderkarte}
\subsection{OSM2World} \index{OpenStreetMap!OSM2World}



\vspace{3mm}
\section{Kinderweltkarte} \index{Kartentypen!Kinderweltkarte}
