...
\vspace{3mm}
\begin{tabular}{>{\centering \arraybackslash}m{1cm} m{14cm}}
\includegraphics[scale=0.5]{images/info.eps} &  Im folgenden wurden alle Abbildungen in der Ansicht \textref{flache Karte} (\textref{Ansichtsmodi}) gemacht, um die Unterschiede der Kartentypen eindeutig hervorzuheben.
\end{tabular}
...
\hline
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Shop.eps}} &  Geschäfte \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Restaurant.eps}} & Restaurants \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_nightlife.eps}} &  Nachtleben \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Bank.eps}} & Bank \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Toilets.eps}} & Toiletten \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Grocery.eps}} & Lebensmittelgeschäft \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_Activity.eps}} & Aktivitäten \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_hiking_cycling.eps}} & Wandern und Radfahren \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_education.eps}} &  Bildung \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{images/POI_health.eps}} &  Gesundheitseinrichtungen \\ 
\hline
