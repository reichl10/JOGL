...
\begin{indents}
\item \textbf{Web Mining:} Automatische Extraktion von Daten aus dem Internet. Bei Jogl Earth findet das Web Mining bei der Suchfunktion z.B. nach Orten Anwendung.

\item \textbf{Interoperabilität:} Das Programm „Jogl Earth“ soll mit OpenStreetMap und der Overpass-API und Ähnlichen Diensten interagieren um das Kartenmaterial mit Zusatzinformationen grafisch zu unterstützen.
\end{indents}


\subsection*{Zuverlässigkeit}
\begin{indents}
\item \textbf{Stabilität:} Die Lauffähigkeit des Programms soll nicht unterbrochen bzw. beeinträchtigt werden.

\item \textbf{Fehlertoleranz:} Das Programm soll trotz fehlerhafter Eingaben seine Funktionsweise aufrechterhalten.

\item \textbf{Wiederherstellbarkeit:} Das Programm soll nach Beendigung wieder im gleichen Zustand verfügbar sein.
\end{indents}


\subsection*{Benutzbarkeit}
\begin{indents}
\item \textbf{Bedienbarkeit:} Die Oberfläche soll intuitiv bedienbar sein.

\item \textbf{Erlernbarkeit:} Die Bedienung der Oberfläche soll einfach verstanden werden.

\item \textbf{Grafische Gestaltung:} Die Oberfläche soll optisch ansprechend wirken.

\item \textbf{Verständlichkeit:} Die Oberfläche soll selbsterklärend sein.
\end{indents}


\subsection*{Effizienz}
\begin{indents}
\item \textbf{Bildqualität:} Die Satellitenbilder und Kartendaten sollen in bestmöglicher Qualität dargestellt werden.

\item \textbf{Laufzeit:} Trotz bestmöglicher Bildqualität sollen die Wartezeiten zum Laden der Daten gering gehalten werden.

\item \textbf{Speichermanagement:} Die Kachel-Daten werden im Dateisystem und im Arbeitsspeicher effizient gepuffert.
\end{indents}


\subsection*{Anpassfähigkeit}
\begin{indents}
\item \textbf{Code-Qualität:} Der Quellcode des Programms soll leicht verständlich gehalten werden.

\item \textbf{Modifizierbarkeit:} Zusätzliche Änderungen bzw. Anpassungen des Codes sollen einfach umsetzbar sein.
\end{indents}


\subsection*{Portierbarkeit}
\begin{indents}
\item \textbf{Erweiterbarkeit:} Zusätzliche Funktionalitäten sollen in den Code integrierbar sein.
