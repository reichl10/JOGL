...
\item Ansichtseinstellungen können gespeichert werden (siehe \textbf{/F390W/})
\item Punkte markieren mit Notiz und Speicherfunktion (siehe \textbf{/F180W/}, \textbf{/F220W/}, \textbf{/F350W/}, \textbf{/F380W/}, \textbf{/F390W/})
...
Bäumen zuschaltbar.
\item Im Sonnensystemmodus werden zusätzliche Himmelskörper wie Sonne und Mond sichtbar, dafür ist die Zoommöglichkeit stark begrenzt.
...
\item Ist die Textur einer Kachel noch nicht geladen wird zuerst versucht sie aus dem Cache im Arbeitsspeicher, dann aus dem Cache im Dateisystem zu laden.
...
\wunsch
\item Um auch Kinder zu motivieren, Jogl Earth zu verwenden, wird eine altersgemäße Kinder-Weltkarte mitausgeliefert.
\muss
...
\item Das Programm wird gestartet. Es öffnet sich die GUI in Standardgröße mit ausgeklappter Seitenleiste im Sonnensystemmodus mit Standardsprache Deutsch. 
\item Wir verkleinern das Fenster, es lässt sich nicht kleiner als Minimalgröße setzen. (F010)
\item Auswahl der Ansichtsmodi (Globus, Kinder-Karte, wieder Sonnensystem) in Seitenleiste, Ansichten ändern sich entsprechen. (F090)
\item Wir versuchen, die Erde durch ziehen der Maus über die Pole zu drehen. Erde dreht sich konsistent, stoppt jedoch bei den Polen. (F200)
\item Ändere Sprache auf Englisch, die Anzeigesprache ändert sich, und wieder zurück auf Deutsch. (F040)


\item Klick auf Einklappsymbol, Seitenleiste klappt ein. (F030)
\item Wir drücken Strg+Q. Das Fenster schliesst sich ohne Rückmeldung. (F020)
...
EclEmma & Erweiterung für \textbf{Eclipse} zum Messen der \textbf{Testabdeckung}\\
...
Zoomlevel & Angabe zur \textbf{Auflösung} der \textbf{(Bild-) Kacheln} in der Ansicht\\
\end{tabularx}
