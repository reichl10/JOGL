...
Die grafische Benutzeroberfläche zeigt dafür im dreidimensionalen Modus eine Weltkugel, die frei gedreht und gezoomt werden kann, und im zweidimensionalen einen Ausschnitt der Weltkarte. Die Steuerung erfolgt mit Tastatur und Maus; Die Karte kann aus verschiedenen Kategorien wie Satellitenbildern oder Straßenkarten gewählt werden.\\
...
\item Zuschaltbare 3D-Modelle für Häuser/Bäume auf der Karte (siehe \ziel{F120W}, \ziel{F230W})
...
\hline
\rule[-1ex]{0pt}{7ex} \includegraphics[scale=0.08]{KeyImages/key_Bild_Auf.eps}  \includegraphics[scale=0.08]{KeyImages/key_Bild_Ab.eps} & Perspektivisches Kippen der Ansicht \\
\hline
...
\item Beim Schließen des Fensters wird die Anwendung ohne Rückfrage beendet.\item Die Einstellungsleiste am linken Rand der GUI ist einklappbar.
...
\item POIs sowie gewisse Einstellungen werden in einer Datei gespeichert, die bei Programmstart geladen wird.
\end{enumerate}
