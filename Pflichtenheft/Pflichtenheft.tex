...
\item Mit OpenGL gerenderte Kartenansicht, die mit Maus und Tastatur intuitiv bedienbar ist (\ziel{F190}, \ziel{F200}, \ziel{F260}, \ziel{F280}, \ziel{F290}, \ziel{F540})
...
\item Dreidimensionales Höhenprofil auf Globus- und Kartenoberfläche (\ziel{F210W}, \ziel{F220W}, \ziel{F320W}, \ziel{F550W})
...
\item Anzeige von Informationen zum Bildmittelpunkt (\ziel{F560W})
...
\end{details}
\vspace{2mm}
Starten des Programms. Es öffnet sich das Hauptfenster.
\begin{enumerate}[leftmargin = 2.2cm]
\wunsch
\item Die GUI startet im Sonnensystemmodus. Die Auswahl des Kartentyps und des Höhenprofils entfällt (gemäß Abbildung 5.1). 
\muss
