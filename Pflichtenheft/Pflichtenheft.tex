...
\newcommand{\W}{\sfbf{W}}
\newcommand{\ziel}[1]{{\fontsize{9.5}{11} \sffamily /#1/}}
...
\hline
\rule[-1ex]{0pt}{7ex} \includegraphics[scale=0.08]{KeyImages/key_Strg.eps} \rule[-1ex]{0pt}{7ex} \textbf{+} \includegraphics[scale=0.08]{KeyImages/key_Q.eps} & Beenden der Anwendung und Schließen der GUI \\ 
\hline
\end{tabular} 
\end{center}
...
\sfbf{Ausgangspunkt:} Nackte Grundinstallation \\
\sfbf{Test:} Szenario - Anwendungsstart \\
\sfbf{Voraussetzung:} keine
\begin{enumerate}[leftmargin = 2.2cm]
...
\vspace{1.0cm}
\sfbf{Ausgangspunkt:} Nackte Grundinstallation \\
\sfbf{Test:} Funktionalität GUI inklusive der gelieferten Texturen \\
\sfbf{Voraussetzung:} Szenario - Anwendungsstart ausführen
\begin{enumerate}[leftmargin = 2.2cm, resume]
...
\vspace{1.0cm}
\sfbf{Ausgangspunkt:} Nackte Grundinstallation \\
\sfbf{Test:} Laden der Kartendaten von OpenStreetMap und NASA \\
\sfbf{Voraussetzung:} Szenario - Anwendungsstart ausführen
\begin{enumerate}[leftmargin = 2.2cm, resume]
...
\vspace{1.0cm}
\sfbf{Ausgangspunkt:} Geladene Kartendaten \\
\sfbf{Test:} Ansichtseinstellungen bei Karten \\
\sfbf{Voraussetzung:} Szenario - Anwendungsstart ausführen
\begin{enumerate}[leftmargin = 2.2cm, resume]
...
\vspace{1.0cm}
\sfbf{Ausgangspunkt:} Geladene Kartendaten \\
\sfbf{Test:} Punkte markieren, POIs \\
\sfbf{Voraussetzung:} Szenario - Anwendungsstart ausführen
\begin{enumerate}[leftmargin = 2.2cm, resume]
\item Auswahl der Ansicht Karte mit Kartentyp OpenStreetMap (Straßenkarte) (siehe \textbf{/F090/}, \textbf{/F110/}).
...
\vspace{1.0cm}
\sfbf{Ausgangspunkt:} Liste der markierten Punkte und die Ansichtseinstellungen werden übernommen \\
\sfbf{Test:} Settings Speicherung \\
\sfbf{Voraussetzung:} Szenario - Anwendungsstart ausführen, Veränderung der Settings-Datei (z.B. markierte Punkte setzen)
\begin{enumerate}[leftmargin = 2.2cm, resume]
\wunsch
