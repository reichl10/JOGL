...
\item Drücken von 'Strg + Q' beendet die Anwendung ohne Rückmeldung (siehe \textbf{/F020/}).
\end{enumerate}
...
Voraussetzung: Szenario - Anwendungsstart ausführen
\begin{enumerate}[leftmargin = 2.5cm, resume]
\item (!) Kartenkacheln laden, Ladebalken für Fortschritt, Platzhaltertextur usw. testen (siehe \textbf{/F060/}, ...)
\item Auswahl der Ansicht Karte mit Kartentyp OpenStreetMap (Straßenkarte) (siehe \textbf{/F090/}, \textbf{/F110/}). (Daten der Karten müssen vorab geladen worden sein!)
\item Drücken des Schließen-Buttons beendet die Anwendung ohne Rückmeldung. Die Einstellungen der Kartendaten müssen gespeichert werden (siehe \textbf{/F020/}).
\end{enumerate}
...
\item Schließen der Anwendung mit Strg + Q. Markierte Punkte werden gespeichert (siehe \textbf{/F020/}).
\end{enumerate}
...
\begin{enumerate}[leftmargin = 2.5cm, resume]
\wunsch
\item Kontrolle ob die Settings-Einstellungen übernommen wurden. (siehe \textbf{/F390W/})
\muss
