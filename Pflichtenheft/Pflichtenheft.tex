...
Wunschkriterien werden mit \W  gekennzeichnet, alle verbleibenden sind Musskriterien.
Daten werden in dem Ordner data relativ zum Ausführungsordner abgelegt.
\section{Einstellungen}
\begin{enumerate}[leftmargin=2cm]
\item Einstellungen werden in einer Datei settings im data Ordner gespeichert. Dazu gehören:
\begin{itemize}
\item Sprache
\item Antialiasing
\item Texturfilter
\item Der gewählte Kartenserver
\item Pufferspeicher größen
\end{itemize}
\end{enumerate}
\section{Ansicht}
\begin{enumerate}[resume,leftmargin=2cm]
\item Die ausgewählte Option unter Ansicht wird in der Datei view im data Ordner gespeichert. Dazu gehören:
\begin{itemize}
\item Der gewählte Ansichtsmodus
\item Die gewählte Karte
\item Höhenprofil
\item 3D-Modelle
\item Ländernamen
\item Städtename
...
\section{Orte}
\begin{enumerate}[resume,leftmargin=2cm]
\item Markierte Punkte und deren Einstellungen werden in der Datei places im data Ordner gespeichert. Dazu gehören die Daten:
\begin{itemize}
\item Name
\item Position
\item Notiz
