...
\begin{itemize}
	...
	\item Die \textit{Statusleiste} \raisebox{-1pt}{\includegraphics[scale=0.45]{Nummern/4.eps}} am unteren Rand beinhaltet Informationen über den zentrierten Punkt, wie Koordinaten und Maßstab. Außerdem wird in ihm der Fortschritt im Hintergrund geladener Daten angezeigt.
\end{itemize}
