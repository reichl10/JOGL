...
\begin{itemize}
\item Intuitiv bedienbare, grafisch ansprechende GUI mit einklappbarer Seitenleiste und\\ Sprachunterstützung für Englisch und Deutsch (\ziel{F010} - \ziel{F040})
\item Bedienung mit Maus und Tastatur (\ziel{F280}, \ziel{F290})
\item Anzeige der momentanen und möglichen Zoomstufen (\ziel{F050}, \ziel{F060})
\item Sinnvolle Beschränkung von Zoom und Beweglichkeit (\ziel{F410}, \ziel{F420}, \ziel{F440} - \ziel{F460})
...
\item Felder zur Anzeige und Änderung des Längen- und Breitengrads (\ziel{F080}, \ziel{F090}, \ziel{F230})
...
\item Drehen, Kippen, Zoomen der Ansichten (\ziel{F400} - \ziel{F460})
\item Text- und Symboloverlays für Städte und POIs, Anzeige der Details dazu im Detailfenster\\(ohne Markierung und Speicherfunktion)(\ziel{F140}, \ziel{F150}, \ziel{F240}, \ziel{F360}, \ziel{F470}, \ziel{570})
\item Beschränkung der Anzahl gleichzeitig geladener Overpass-Einträge zur Ressourcenschonung \\(siehe \ziel{F470})
\item Effizientes, asynchrones Laden von Daten durch Caching (\ziel{F500} - \ziel{F530}, \ziel{F610})
...
\item Speichern und Laden von Einstellungen (\ziel{F590}, \ziel{F600})
\end{itemize}
...
\item Dreidimensionales Höhenprofil auf Globus- und Kartenoberfläche (\ziel{F210W}, \ziel{F220W})
\item Änderung des Detailgrads des 3D-Modells (siehe \ziel{F330W})
\item Funktion zum Markieren und Speichern von Punkten (\ziel{F120W}, \ziel{F130W}, \ziel{F230}, \ziel{F370W}, \ziel{F480W}, \ziel{F490W})
\item Lokale und Globale Suchfunktion (\ziel{F160W} - \ziel{F180W}, \ziel{F580W})
...
\item Asynchrones Ausführen der Datenoperationen \ziel{F540} - \ziel{F580W}
\end{enumerate}
...
\end{itemize}
\item Einstellungen werden in der Datei \texttt{settings} im Datenverzeichnis gespeichert. Zu den darin gespeicherten Daten gehören:
\begin{itemize}
