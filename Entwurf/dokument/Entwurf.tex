...
\begin{lstlisting}
interface RequestListener<Key, Value>
\end{lstlisting}
Nimmt eine asynchrone Antwort einer \textit{Source} entgegen.\\
...
In diesem Package sind vorerst keine Enumerations vorgesehen.\\
...
\begin{tabular}{|c|l|}
\hline
\textit{PLANE} & Kamera bewegt sich in der Kartenebene \\
\hline
\textit{SPHERE} & Kamera rotiert um den Globus \\
\hline
\end{tabular}
