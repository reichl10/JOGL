...
\section{Packages}
Folgende Abbildung zeigt einen Überblick über die gesamten Packages.\\
...
In diesem Abschnitt werden die Packages im Detail erklärt.
...
\vspace{5mm}
\section{de.joglearth.rendering}
...
Eine größere Version des Diagramms findet sich im Anhang (\textref Abbildung 8.1).
...
\begin{rotate}{90}
\textbf{Abbildung 9.1:} Laden einer lokal noch nicht vorhandenen Kachel
\end{rotate}
\end{centering}
\restoregeometry
