...
\item 
void {\bf put\-Integer} (final \-String key, final \-Integer value)
\item 
void {\bf put\-Double} (final \-String key, final \-Double value)
\item 
void {\bf put\-Float} (final \-String key, final \-Float value)
\item 
void {\bf put\-Long} (final \-String key, final \-Long value)
\item 
void {\bf put\-Location} (final \-String key, final {\bf \-Location} value)
\item 
void {\bf put\-Boolean} (final \-String key, final \-Boolean value)
\item 
void {\bf put\-String} (final \-String key, final \-String value)
\item 
\-Boolean {\bf get\-Boolean} (final \-String key)
\item 
\-String {\bf get\-String} (final \-String key)
\item 
\-Long {\bf get\-Long} (final \-String key)
\item 
\-Float {\bf get\-Float} (final \-String key)
\item 
\-Double {\bf get\-Double} (final \-String key)
\item 
\-Integer {\bf get\-Integer} (final \-String key)
\item 
\-Set$<$ {\bf \-Location} $>$ {\bf get\-Locations} (final \-String key)
\end{DoxyCompactItemize}
\subsection*{Öffentliche, statische \-Methoden}
\begin{DoxyCompactItemize}
\item 
static {\bf \-Settings} {\bf get\-Instance} ()
\end{DoxyCompactItemize}


\subsection{\-Ausführliche \-Beschreibung}
\-Used to store settings of \doxyref{\-Jogl\-Earth}{\-S.}{classde_1_1joglearth_1_1_jogl_earth}. \-A key can only have one value. \-If put a value of an other type under the same key it replaces the old value of the other type. \-For key the {\ttfamily null} object is not allowed. \-This \-Class is thread save. 
...
\subsubsection[{add\-Settings\-Listener}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-add\-Settings\-Listener} (
...
\subsubsection[{get\-Boolean}]{\setlength{\rightskip}{0pt plus 5cm}\-Boolean {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Boolean} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a0f905e7545cc3179eae9f2d328c5f442}
...
\subsubsection[{get\-Double}]{\setlength{\rightskip}{0pt plus 5cm}\-Double {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Double} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a6f17aed23ce488286b5aa028cd4a12f0}
...
\subsubsection[{get\-Float}]{\setlength{\rightskip}{0pt plus 5cm}\-Float {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Float} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a7dd8b3e230453ddea7533b406f2835ce}
...
\subsubsection[{get\-Instance}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf \-Settings} {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Instance} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  [static]}}\label{classde_1_1joglearth_1_1settings_1_1_settings_a34cf3483855ab55d8b3df0421ff7c574}
...
\subsubsection[{get\-Integer}]{\setlength{\rightskip}{0pt plus 5cm}\-Integer {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Integer} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a08fbd63abc11e1b0bd5e676b74409980}
...
\subsubsection[{get\-Locations}]{\setlength{\rightskip}{0pt plus 5cm}\-Set$<${\bf \-Location}$>$ {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Locations} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a0e4d847417d51c305a7cb05dd26a24ee}
...
\subsubsection[{get\-Long}]{\setlength{\rightskip}{0pt plus 5cm}\-Long {\bf de.\-joglearth.\-settings.\-Settings.\-get\-Long} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_aa2aeb453fb3760a31308dd34355d0cc3}
...
\subsubsection[{get\-String}]{\setlength{\rightskip}{0pt plus 5cm}\-String {\bf de.\-joglearth.\-settings.\-Settings.\-get\-String} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_acfd30089cd2b2b899cc94263c0e6d697}
...
\subsubsection[{put\-Boolean}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Boolean} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-Boolean}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_ad921660f145305132ff8c06bc0fd9daf}
...
\subsubsection[{put\-Double}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Double} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-Double}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_ada5b1d3bea8ee3f65872aab2c3f3ed14}
...
\subsubsection[{put\-Float}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Float} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-Float}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_abecdaf86fc41c5be6080ed7579d95e7d}
...
\subsubsection[{put\-Integer}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Integer} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-Integer}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a7df4e5a79184b222d8fc55ea1036cd12}
...
\subsubsection[{put\-Location}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Location} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final {\bf \-Location}}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_a37523505471c0fbe84461a3fe1388082}
...
\subsubsection[{put\-Long}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-Long} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-Long}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_abd2f02ce0f4f58c5228fa5586a13ab32}
...
\subsubsection[{put\-String}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-put\-String} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final \-String}]{value}
\end{DoxyParamCaption}
)}\label{classde_1_1joglearth_1_1settings_1_1_settings_af2ed333e28e0de489cd63291efcf6a1d}
...
\subsubsection[{remove\-Settings\-Listener}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf de.\-joglearth.\-settings.\-Settings.\-remove\-Settings\-Listener} (
\begin{DoxyParamCaption}
\item[{final \-String}]{key, }
\item[{final {\bf \-Settings\-Listener}}]{listener}
\end{DoxyParamCaption}
