...
\begin{itemize}
 ...
 \item Das String-Attribut \texttt{type} kann einen der folgenden Werte enthalten: Integer, Boolean, Long, Double, Float, String.
  Dieser Typ definiert zu welchem Java Standard API Typ der String im \texttt{value} Attribut geparsed werden muss, und aus welchem Typ er mittels \texttt{toString} umgewandelt wurde.
