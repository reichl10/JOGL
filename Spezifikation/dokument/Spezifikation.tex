...
Die Suche nach Orten oder Sehenswürdigkeiten erfolgt über Nominatim dafür wird von OpenStreetMap der Server \textit{http://nominatim.openstreetmap.org/search/} bereitgestellt. \\
...
\hline
\hline
q = $<$query$>$ & Suchbegriff (Ort oder Sehenswürdigkeit) \\
\hline
format = [xml$|$json] & Format der Rückgabe \\
\hline
accept-language = [de$|$en] & Sprache in der die Suchergebnisse angezeigt werden sollen. Bei der Angabe mehrerer Sprachen, z.B. \textit{accept-language = de,en} wird das Suchergebnis vorrangig in Deutsch und nachranging in Englisch übermittelt. \\
\hline
viewbox = $<$left$>$,$<$top$>$,$<$right$>$,$<$bottom$>$ & Begrenzung des Suchbereichs (FOV). Vergleichbar mit \textit{$<$bbox-query  n="{}$<$top$>$"{} s="{}$<$bottom$>$"{} w="{}$<$left$>$"{} e="{}$<$right$>$"{}  /$>$} in der Overpass-API. \\
\hline
limit = $<$integer$>$ & Gibt an wie viele Ergebnisse maximal zurückgegeben werden sollen. Standardwert von Nominatim ist 10.\\
\hline
adressdetails = [0$|$1] & Erweitert die Suchergebnisse um Details zu den Adressen. \textit{0} bedeutet \textit{aus} und \textit{1} bedeutet \textit{an}. \\
\hline
\end{tabular}
...
\hline
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=0.6]{POI_Shop.eps}} &  SHOPS \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=0.2]{POI_Restaurants.eps}} & RESTAURANTS \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.4]{POI_nightlife.eps}} &  NIGHTLIFE \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.4]{POI_Bank.eps}} & BANK \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.7]{POI_Grocery.eps}} & GROCERY \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.7]{POI_Activity.eps}} & ACTIVITY \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=0.6]{POI_hiking_cycling.eps}} & HIKING\_CYCLING \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{POI_education.eps}} &  EDUCATION \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{POI_health.eps}} &  HEALTH \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{POI_post.eps}} &  POST \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \parbox[c]{1em}{\includegraphics[scale=1.6]{POI_hotels.eps}} &  HOTELS \\ 
\hline
...
\begin{longtable}{|p{4cm} p{10cm}|}%{L{0.35} R{1.65}}
\hline
\rule[-1ex]{0pt}{4ex} HIKING\_CYCLING &   
\begin{lstlisting}
<osm-script>
  <union>
  <query type="node">
...
\chapter{Verbesserungen gegenüber dem Entwurf}
