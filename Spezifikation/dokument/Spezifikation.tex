...
\hline
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} &  Logo von \JoglEarth \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} & Programm-Icon \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} &  Stecknadel zum markieren eines Punktes \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} & Stecknadel zum entfernen eines Punktes \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} & Plus beim Zoomen \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} & Minus beim Zoomen \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} & Maßstab \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} &  Handbuch-Icon \\ 
\hline
\rule[-1ex]{0pt}{4ex}  \includegraphics[scale=0.5]{Logo-Print.eps} &  About-Icon \\ 
\hline
