...
Implements the \doxyref{Object\-Measure}{S.}{} interface in such way that it can measure the size of single objects. Treats every object as a object of the size 1. 
