...
\subsubsection[{request\-Object}]{\setlength{\rightskip}{0pt plus 5cm}\-Source\-Response$<$\-Value$>$ de.\-joglearth.\-source.\-Source$<$ \-Key, \-Value $>$.{\bf request\-Object} (
...
\-Tries to load and return an object if it available locally. \-Otherwise it is attempted to load the object in an asynchronous way.
