...
Static class for the interpolation of information about the height of points displayed on the map. For that purpose S\-R\-T\-M height data is used. A \doxyref{de.\-joglearth.\-rendering.\-Tessellator}{S.}{interfacede_1_1joglearth_1_1rendering_1_1_tessellator} uses this class to generate a map surface by the \doxyref{Height\-Map}{S.}{classde_1_1joglearth_1_1surface_1_1_height_map}. 
...
Tries to determine the height of a point using the S\-R\-T\-M data that contains its \doxyref{de.\-joglearth.\-geometry.\-Geo\-Coordinates}{S.}{classde_1_1joglearth_1_1geometry_1_1_geo_coordinates} or returns default {\ttfamily 0} if no value was found.
