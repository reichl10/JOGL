...
Klassendiagramm für de.\-joglearth.\-geometry.\-Geo\-Coordinates\-:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{classde_1_1joglearth_1_1geometry_1_1_geo_coordinates}
\end{center}
\end{figure}
...
Coordinates are given in the format /[0-\/9]?[0-\/9]$\ast$°$\ast$([0-\/9]?[0-\/9]$\ast$'($\ast$[0-\/9]?{\tt 0-\/9}?$\ast$\char`\"{})?)?$|$[0-\/9]+(.[0-\/9]+)?/
...
\begin{DoxyParams}{Parameter}
{\em lon} & The longitude, in the format $\ast$(coord)$\ast$[W\-E]?$\ast$, e.\-g. 55° 17' 48.\-2\char`\"{} E
@param lat The latitude, in the format \textbackslash{}s$\ast$(coord)\textbackslash{}s$\ast$[\-N\-S]?\textbackslash{}s$\ast$, e.\-g. 55° 17' 48.\-2\char`\"{} N \\
\hline
\end{DoxyParams}
