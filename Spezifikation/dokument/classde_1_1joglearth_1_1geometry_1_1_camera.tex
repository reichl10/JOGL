...
This class is not thread-\/safe by design, as clients will usually perform multiple dependent operations on the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera}. In multi-\/threaded code, these blocks of operations should be synchronized on the camera object. 
...
Creates a \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera} with F\-O\-V 90, aspect ratio 1\-:1, z\-Near=0.\-1 and z\-Far=1000. 
...
Adds a new \doxyref{Camera\-Listener}{S.}{interfacede_1_1joglearth_1_1geometry_1_1_camera_listener}.
...
Returns an array of tiles visible or partially visible by the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera}.
...
Determines whether a surface point is visible by the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera}. The visibility is limited by both the viewport (the clipping planes) and parts of the scene closer to the camera that might shadow others (the back of the globe, for example).
...
Changes the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera}'s surface position by difference values.
...
Removes a given \doxyref{Camera\-Listener}{S.}{interfacede_1_1joglearth_1_1geometry_1_1_camera_listener}.
...
Resets the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera} tilt to x=y=0. \index{de\-::joglearth\-::geometry\-::\-Camera@{de\-::joglearth\-::geometry\-::\-Camera}!set\-Distance@{set\-Distance}}
...
Sets the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera}'s distance to the surface.
...
Sets a new \doxyref{Geometry}{S.}{interfacede_1_1joglearth_1_1geometry_1_1_geometry} object for model-\/specific computations.
...
Sets the position the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera} is currently over.


\begin{DoxyParams}{Parameter}
{\em coords} & The \doxyref{Geo\-Coordinates}{S.}{classde_1_1joglearth_1_1geometry_1_1_geo_coordinates} of the camera's position. \\
\hline
\end{DoxyParams}
...
Sets the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera} tilt to a specific value.
