...
\subsection*{횜ffentliche Methoden}
\begin{DoxyCompactItemize}
\item 
{\bf Camera} ()
\item 
...
\subsection{Ausf체hrliche Beschreibung}
...
Changes the surface position of the \doxyref{Camera}{S.}{classde_1_1joglearth_1_1geometry_1_1_camera} by difference values.
...
\begin{DoxyParams}{Parameter}
{\em fov} & The field of view, in radians. This is the angular distance of the left and right clipping plane. 90째 (P\-I/2) by default \\
\hline
