...
$<$ {\bf Location} $>$ $>$ {\bfseries request\-Object} ({\bf Nominatim\-Query} key, Source\-Listener$<$ {\bf Nominatim\-Query}, Collection$<$ {\bf Location} $>$$>$ sender)\label{classde_1_1joglearth_1_1source_1_1nominatim_1_1_nominatim_source_aa1e38f9369986f7ad5d82a893552ecd5}

\end{DoxyCompactItemize}


\subsection{Ausführliche Beschreibung}
Provides responses of search requests, for e.\-g. search requests for places or detailed information to a point. The response will be prepared for the \doxyref{de.\-joglearth.\-surface.\-Location\-Manager}{S.}{classde_1_1joglearth_1_1surface_1_1_location_manager}; uses the \doxyref{de.\-joglearth.\-util.\-H\-T\-T\-P}{S.}{classde_1_1joglearth_1_1util_1_1_h_t_t_p} for the search request. 
...
Constructor. Initializes the \doxyref{de.\-joglearth.\-source.\-nominatim.\-Nominatim\-Source}{S.}{}. 