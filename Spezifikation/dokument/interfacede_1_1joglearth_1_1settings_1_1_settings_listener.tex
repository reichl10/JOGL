...
\hline
{\em val\-Old} & The old value of the setting, can be {\ttfamily null} if there wasn't any \\
\hline
{\em val\-New} & The new value of the setting, can be {\ttfamily null} \\
\hline
\end{DoxyParams}
