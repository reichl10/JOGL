...
public final class SettingsContract {
    ...
    /**
     * Inserts the default values for each of the settings defined in this
     * contract.
     */
    ...
    /**
     * Loads the values for the settings defined in this contract from a file.
     * This loads from the same files the {@link #saveSettings()} saves to.
     */
