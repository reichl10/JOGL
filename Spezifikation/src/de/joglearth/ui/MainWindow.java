...
public class MainWindow extends JFrame {
	...
	private void initializeSettingsTab() {
		...
		languageComboBox.addItem(new IconizedItem<Locale>(
				"Deutsch", loadIcon("icons/flagGer.png"), //$NON-NLS-1$ //$NON-NLS-2$
					...
					if (camera != null) {
						...
						if (selected != null) {
							...
							case SOLAR_SYSTEM:
							    ...
							    // Settings.getInstance().putString(SettingsContract., value);
							case GLOBE_MAP:
	 ...
	 *            The <code>LocationManager</code> associated with this window.
	 * @param camera
