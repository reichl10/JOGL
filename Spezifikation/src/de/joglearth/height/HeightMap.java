...
public interface HeightMap {
     ...
     * sized longitude / latitude steps. It is scaled equally to the surface coordinate's 
     * radians values, meaning that height "0" is sea level and "1" has a magnitude of the earth's
     * mean radius (around 6378 km, or exactly HEIGHT_UNIT_METERS).
